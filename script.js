...
const sqrs = Array.from(document.getElementsByClassName('w')).concat(Array.from(document.getElementsByClassName('b')))


for(const sqr of sqrs){
    sqr.addEventListener('click',()=>{
        if(sqr.classList.value.length == 4){
            switch(sqr.classList.slice(2)){
